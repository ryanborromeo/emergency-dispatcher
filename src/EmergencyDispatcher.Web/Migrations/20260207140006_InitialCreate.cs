        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriageContactName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    TriagePhone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    TriageWhatsApp = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredHospitalId = table.Column<int>(type: "integer", nullable: true),
                    ConsentFlag = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Hospitals_PreferredHospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyType = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    EstimatedEta = table.Column<int>(type: "integer", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    HospitalId = table.Column<int>(type: "integer", nullable: true),
                    NotifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NotifiedVia = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_PreferredHospitalId",
                table: "Members",
